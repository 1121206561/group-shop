...
@Component
@DependsOn({"constantDefineUtil"}) //注意小写
public class QcloudProvider {
    ...
    public String FileToCos(InputStream file) {
        ...
        String key = new DateTime().toString("yyyy/MM/dd") + fileName;
        ...
        // 这里设置签名过期时间
        Date expirationDate = new Date(System.currentTimeMillis() + 30L * 60L * 1000L * 1000 * 100 * 100);
